<template language="pug"><div class="ui container"><h1>RightScale Exercise</h1><cnavbar></cnavbar><br/><br/><home v-if="hash == 'home' || hash == ''"></home><page2 v-if="hash == 'page2'"></page2><page3 v-if="hash == 'page3'"></page3><!-- FROM RENDER--><div style="height: 0; opacity: 0; position: absolute; z-index: -100;"><div id="___serverdata">{{device}}</div><div id="___vuepages">{{pages}}</div></div></div></template><script>export default {
  data: function() {
    return {
